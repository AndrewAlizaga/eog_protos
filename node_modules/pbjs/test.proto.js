...
function encodeMapTestLongAndBool(message) {
    let bb = popByteBuffer();
    _encodeMapTestLongAndBool(message, bb);
    return toUint8Array(bb);
}
exports.encodeMapTestLongAndBool = encodeMapTestLongAndBool;
...
function decodeMapTestLongAndBool(binary) {
    return _decodeMapTestLongAndBool(wrapByteBuffer(binary));
}
exports.decodeMapTestLongAndBool = decodeMapTestLongAndBool;
